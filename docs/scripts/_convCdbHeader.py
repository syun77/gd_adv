...
###################################################################
# *.cdb から YAML形式の定数ファイルと GMLの定数スクリプトを生成する
# code-snippetsも出力する
###################################################################
...
class DefineMgr:
	...
	def writeGML(self):
		fOut = "%s/../../scripts/scr_const/scr_const.gml"%(self.root)
		...
		writer.write("//////////////////////////////")
		writer.write("")
		writer.write("function scrConst() {") # start function.
